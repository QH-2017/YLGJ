...
const content = [
  ...
  `三、团队精神训练`,
  ``,
  `本项目由7人团队协作完成，我担任后端开发角色。在团队合作中，我深刻体会到沟通的重要性。项目初期，由于前后端接口定义不够清晰，导致联调时出现了大量返工。经过团队讨论后，我们制定了统一的接口文档规范，使用Swagger进行接口管理，大大提高了协作效率。此外，在面对项目进度压力时，团队成员互相支持、主动分担任务，这种团结互助的精神是项目能够最终顺利完成的关键。通过这次实训，我学会了如何在团队中定位自己的角色、如何有效地进行技术沟通、以及如何协调个人进度与团队目标的一致性。`,
  ``,
  `四、职业道德培养`,
  ``,
